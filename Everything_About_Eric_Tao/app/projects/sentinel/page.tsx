...
export default async function SentinelPage() {
 ...
 <h2 className="text-2xl font-semibold">The workbench, live</h2>
 ...
 {writeup && (
 <section>
 <h2 className="text-2xl font-semibold">Writeup</h2>
 <div className="mt-4 space-y-4 text-muted-foreground [&_h2]:mt-8 [&_h2]:text-lg [&_h2]:font-semibold [&_h2]:text-foreground [&_li]:leading-relaxed [&_p]:leading-relaxed [&_strong]:text-foreground [&_ul]:list-disc [&_ul]:space-y-1 [&_ul]:pl-5">
