...
const photographySlides = [
  { id: 1, title: "Urban Light", tone: "from-[#1b1b1b] via-[#0f0f0f] to-[#2a1b12]" },
  { id: 2, title: "Portrait Study", tone: "from-[#151515] via-[#0b0b0b] to-[#1f1f1f]" },
  { id: 3, title: "Golden Hour", tone: "from-[#20160d] via-[#140f0a] to-[#3a2716]" },
  { id: 4, title: "Minimal Still", tone: "from-[#0f1014] via-[#0a0b0f] to-[#191b23]" },
  { id: 5, title: "Street Motion", tone: "from-[#18120f] via-[#0e0b09] to-[#2c1d17]" },
]
      ...
      <div className="overflow-x-auto pb-4 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
        <div className="flex gap-6 snap-x snap-mandatory px-2">
          {photographySlides.map((slide) => (
            ...
            >
              <div className={cn("absolute inset-0 bg-gradient-to-br", slide.tone)} />
              ...
              <div className="relative z-10 flex h-full items-end p-6">
                <div>
                  ...
                  <p className="mt-2 text-sm text-white/70">Placeholder frame — replace with real photos.</p>
                </div>
              </div>
            </div>
          ))}
